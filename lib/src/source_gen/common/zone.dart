...
Future<dynamic> exec(_SimpleCallback fn,
    {Logger log, OfflineCompiler templateCompiler}) async {
...
/// there is no [Logger] registered on the current zone. Instead,
/// import `logging.dart` and use the `log` value it exports, which defines a
/// reasonable default value.
Logger get log => Zone.current[_loggerKey] as Logger;

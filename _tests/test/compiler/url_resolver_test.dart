  ...
  group('UrlResolver', () {
    ...
    group('packages', () {
      ...
      test(
          ...
          'provided', () async {
        var fixture = await new NgTestBed<ResolverGetter>().create();
        UrlResolver resolver;
        await fixture.update((ResolverGetter component) {
...
@Component(
  selector: 'resolver-getter',
  providers: COMPILER_PROVIDERS,
  template: '',
)
class ResolverGetter {
  final UrlResolver resolver;
  ResolverGetter(this.resolver);
}

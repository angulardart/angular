...
void main() {
  ...
  test('should consume text binding', () async {
    final testBed =
        NgTestBed.forComponent(ng.createBoundTextComponentFactory());
  ...
  test('should consume property binding', () async {
    final testBed =
        NgTestBed.forComponent(ng.createBoundPropertyComponentFactory());
    final testFixture = await testBed.create();
  ...
  test('should consume ARIA attribute binding', () async {
    final testBed =
        NgTestBed.forComponent(ng.createBoundAriaAttributeComponentFactory());
    final testFixture = await testBed.create();
    final div = testFixture.rootElement.querySelector('div');
  ...
  test('should remove attribute when bound expression is null', () async {
    final testBed =
        NgTestBed.forComponent(ng.createBoundAttributeComponentFactory());
    final testFixture = await testBed.create();
    final div = testFixture.rootElement.querySelector('div');
  ...
  test('should remove style when bound expression is null', () async {
    final testBed =
        NgTestBed.forComponent(ng.createBoundStyleComponentFactory());
    final testFixture = await testBed.create();
    final div = testFixture.rootElement.querySelector('div');
  ...
  test('should consume innerHtml binding', () async {
    final testBed =
        NgTestBed.forComponent(ng.createBoundInnerHtmlComponentFactory());
    final testFixture = await testBed.create();
    final div = testFixture.rootElement.querySelector('div');
  ...
  test('should consume className binding using class alias', () async {
    final testBed =
        NgTestBed.forComponent(ng.createBoundClassNameAliasFactory());
    final testFixture = await testBed.create();
    final div = testFixture.rootElement.querySelector('div');

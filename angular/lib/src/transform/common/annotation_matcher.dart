...
const _INJECTABLES = const [
  const ClassDescriptor('Injectable',
      'package:angular/src/core/di/decorators.dart'),
  const ClassDescriptor(
      'Injectable', 'package:angular/core.dart'),
  const ClassDescriptor('Injectable',
      'package:angular/src/core/di.dart'),
  const ClassDescriptor('Injectable',
      'package:angular/angular.dart'),
  const ClassDescriptor(
      'Injectable', 'package:angular/di.dart'),
  const ClassDescriptor('Injectable',
      'package:angular/web_worker/worker.dart'),
];

const _DIRECTIVES = const [
  const ClassDescriptor('Directive',
      'package:angular/src/core/metadata/directive.dart',
      superClass: 'Injectable'),
  const ClassDescriptor('Directive',
      'package:angular/src/core/metadata.dart',
      superClass: 'Injectable'),
  const ClassDescriptor(
      'Directive', 'package:angular/angular.dart',
      superClass: 'Injectable'),
  const ClassDescriptor(
      'Directive', 'package:angular/di.dart',
      superClass: 'Injectable'),
  const ClassDescriptor(
      'Directive', 'package:angular/core.dart',
      superClass: 'Injectable'),
  const ClassDescriptor('Directive',
      'package:angular/web_worker/worker.dart',
      superClass: 'Injectable'),
...
const _COMPONENTS = const [
  ...
  const ClassDescriptor('Component',
      ...
      superClass: 'Directive'),
  const ClassDescriptor(
      'Component', 'package:angular/angular.dart',
      superClass: 'Directive'),
  const ClassDescriptor(
      'Component', 'package:angular/core.dart',
      superClass: 'Directive'),
  const ClassDescriptor('Component',
      'package:angular/web_worker/worker.dart',
      superClass: 'Directive'),
...
const _PIPES = const [
  ...
  const ClassDescriptor('Pipe',
      ...
      superClass: 'Injectable'),
  const ClassDescriptor(
      'Pipe', 'package:angular/angular.dart',
      superClass: 'Injectable'),
  const ClassDescriptor(
      'Pipe', 'package:angular/di.dart',
      superClass: 'Injectable'),
  const ClassDescriptor(
      'Pipe', 'package:angular/core.dart',
      superClass: 'Injectable'),
  const ClassDescriptor('Pipe',
      'package:angular/web_worker/worker.dart',
      superClass: 'Injectable'),
...
const _VIEWS = const [
  const ClassDescriptor(
      'View', 'package:angular/angular.dart'),
  const ClassDescriptor(
      'View', 'package:angular/di.dart'),
  const ClassDescriptor('View',
      'package:angular/web_worker/worker.dart'),
  const ClassDescriptor(
      'View', 'package:angular/core.dart'),
  const ClassDescriptor('View',
      'package:angular/src/core/metadata/view.dart'),
  const ClassDescriptor('View',
      'package:angular/src/core/metadata.dart'),
];

const _ENTRYPOINTS = const [
  const ClassDescriptor('AngularEntrypoint',
      'package:angular/angular.dart'),
  const ClassDescriptor('AngularEntrypoint',
      'package:angular/di.dart'),
  const ClassDescriptor('AngularEntrypoint',
      'package:angular/core.dart'),
  const ClassDescriptor('AngularEntrypoint',
      'package:angular/platform/browser.dart'),
  const ClassDescriptor('AngularEntrypoint',
      'package:angular/platform/worker_app.dart'),
  const ClassDescriptor('AngularEntrypoint',
...
const _INJECTOR_MODULES = const [
  const ClassDescriptor('InjectorModule',
      'package:angular/src/core/metadata.dart'),
  const ClassDescriptor('InjectorModule',
      'package:angular/angular.dart'),
  const ClassDescriptor(
      'InjectorModule', 'package:angular/di.dart'),
  const ClassDescriptor('InjectorModule',
      'package:angular/core.dart'),
  const ClassDescriptor('InjectorModule',
      'package:angular/web_worker/worker.dart'),

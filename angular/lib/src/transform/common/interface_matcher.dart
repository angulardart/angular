...
const _ON_CHANGE_INTERFACES = const [
  const ClassDescriptor(
      'OnChanges', 'package:angular/angular.dart'),
  const ClassDescriptor('OnChanges',
      'package:angular/lifecycle_hooks.dart'),
  const ClassDescriptor('OnChanges',
      'package:angular/src/core/metadata.dart'),
  const ClassDescriptor(
      'OnChanges', 'package:angular/core.dart'),
  const ClassDescriptor('OnChanges',
      'package:angular/src/core/src/core/meta/lifecycle_hooks.dart'),
];
const _ON_DESTROY_INTERFACES = const [
  const ClassDescriptor(
      'OnDestroy', 'package:angular/angular.dart'),
  const ClassDescriptor('OnDestroy',
      'package:angular/lifecycle_hooks.dart'),
  const ClassDescriptor('OnDestroy',
      'package:angular/src/core/metadata.dart'),
  const ClassDescriptor(
      'OnDestroy', 'package:angular/core.dart'),
  const ClassDescriptor('OnDestroy',
      'package:angular/src/core/src/core/meta/lifecycle_hooks.dart'),
];
const _DO_CHECK_INTERFACES = const [
  const ClassDescriptor(
      'DoCheck', 'package:angular/angular.dart'),
  const ClassDescriptor('DoCheck',
      'package:angular/lifecycle_hooks.dart'),
  const ClassDescriptor('DoCheck',
      'package:angular/src/core/metadata.dart'),
  const ClassDescriptor(
      'DoCheck', 'package:angular/core.dart'),
  const ClassDescriptor('DoCheck',
      'package:angular/src/core/src/core/meta/lifecycle_hooks.dart'),
];
const _ON_INIT_INTERFACES = const [
  const ClassDescriptor(
      'OnInit', 'package:angular/angular.dart'),
  const ClassDescriptor('OnInit',
      'package:angular/lifecycle_hooks.dart'),
  const ClassDescriptor('OnInit',
      'package:angular/src/core/metadata.dart'),
  const ClassDescriptor(
      'OnInit', 'package:angular/core.dart'),
  const ClassDescriptor('OnInit',
      'package:angular/src/core/src/core/meta/lifecycle_hooks.dart'),
];
const _ON_AFTER_CONTENT_INIT_INTERFACES = const [
  const ClassDescriptor('AfterContentInit',
...
const _ON_AFTER_CONTENT_CHECKED_INTERFACES = const [
  const ClassDescriptor('AfterContentChecked',
      'package:angular/angular.dart'),
  const ClassDescriptor('AfterContentChecked',
      'package:angular/lifecycle_hooks.dart'),
  const ClassDescriptor('AfterContentChecked',
...
const _ON_AFTER_VIEW_INIT_INTERFACES = const [
  const ClassDescriptor('AfterViewInit',
      'package:angular/angular.dart'),
  const ClassDescriptor('AfterViewInit',
      'package:angular/lifecycle_hooks.dart'),
  const ClassDescriptor('AfterViewInit',
...
const _ON_AFTER_VIEW_CHECKED_INTERFACES = const [
  const ClassDescriptor('AfterViewChecked',
      'package:angular/angular.dart'),
  const ClassDescriptor('AfterViewChecked',
      'package:angular/lifecycle_hooks.dart'),
  const ClassDescriptor('AfterViewChecked',

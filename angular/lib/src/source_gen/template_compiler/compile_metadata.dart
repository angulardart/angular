...
class CompileTypeMetadataVisitor
  ...
  CompileTokenMetadata _token(
    ...
    if (token == null) {
      ...
      return new CompileTokenMetadata(
          identifier: _identifierForFunction(token.type.element as FunctionTypedElement));
    }
  ...
  o.Expression _useValueExpression(DartObject token) {
    if (token == null || token.isNull) {
      ...
      return o.importExpr(_identifierForFunction(token.type.element as FunctionTypedElement));
    } else {

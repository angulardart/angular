...
<!-- !g3-begin(G3DOC) -->
go/effective-angular-dart/change_detection
...
*   [Components](#components)
    ...
    *   [PREFER setters to `ngAfterXChecked`](#prefer-settings-to-ngafterxchecked)
...
care about. The trade-off you are making is that you have to write your own
